...
public abstract class MapTest {
    ...
    //Use some test cases from MapOnQueue
    ...
    public final void testAddEmpty() {
        ...
        m.add("word", "column");
        Map<String, String> mExpected = this.createFromArgsTest("word", "column");
    ...
    public final void testRemoveNonEmpty() {
        Map<String, String> m = this.createFromArgsTest("a", "b", "c", "d", "e", "f");
        Pair<String, String> p = m.remove("a");
        Map<String, String> mExpected = this.createFromArgsRef("c", "d", "e", "f");
    ...
    /**
     * Test case for hasKey with multiple pairs.
     */
    @Test
    ...
    /**
     * Tests hasKey for to expect a false result.
     */
    @Test
