...
public class List3<T> extends ListSecondary<T> {
    ...
    public final void addRightFront(T x) {
        ...
        //adds data into p
        p.data = x;
        //finds the first right node and makes it p
        p.next = q.next;
        q.next = p;

        //case if adding if right is empty
    ...
    public final T removeRightFront() {
        ...
        Node t = q.next;
        T x = t.data;
        //removes t from right
        q.next = t.next;
        //decrements right length
        this.rightLength--;
        assert this.conventionHolds();
    ...
    public final void advance() {
        ...
        //moves one node from right list to the left list
    ...
    public final void moveToStart() {
        ...
        //resets the left list to be empty
        this.lastLeft = this.preStart;
